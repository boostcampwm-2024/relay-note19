...
선정 이유: 네트워킹이 중요하다고 느꼈고 내가 주도해서 한번 해보고 싶었다!
...
선정 이유: 지속적으로 달려나가려면 휴식도 중요하다고 생각해서 선택했습니다.

수행 내용

맛있는 밥을 해먹으면서 리프레시를 합니다!

<img src="https://github.com/user-attachments/assets/202d5ee3-bf71-43a0-8086-e200544b64b3" width="200" height="200"/>

## J085_노현진

- **퀘스트 : 밥 먹을 때 볼 영상 피어세션 마지막에 피어분들께 추천해주기(이전 : 노트북 재우기)**
- **수행기준**
    - 피어분들께 밥 먹을 때 볼 영상 추천해주기(예를 들면 점심드실 때 무한도전 ..편 재밌어요!)
    
    > 수정하는 이유: 학습정리에 활용할 탭들 노트북 꺼버리면 다 닫혀서 마음이 아파요..ㅠㅠ
    > 
- **선정 이유**
    - 정적인 분위기 속에서 밥을 먹으면 힘이 나지 않을 것 같아서 밥 먹을 때 영상을 보면서 조금이라도 리프레시가 되었으면 하는 마음에 선택했습니다.
- **수행 내용**
    - 다들 피어세션 때 열심히 질문하고 의견을 공유함으로써 밥 먹을 때 볼 영상을 추천할 용기를 내지 못했습니다. 비록 퀘스트를 수행하지는 못했지만 동료들에게 추천할 영상을 고민했던 과정 그 자체도 의미가 있었다고 생각합니다.
